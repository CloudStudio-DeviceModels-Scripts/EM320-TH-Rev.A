...
# Parsing + Configuration Script – EM320-TH - Rev. A

This **Parsing + Configuration** script is designed for the **EM320-TH** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EM320-TH Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **EM320-TH** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
